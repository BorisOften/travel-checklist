//
//  PastListTableViewController.swift
//  my-travel-checklist
//
//  Created by Boris Ofon on 11/22/22.
//

import UIKit

class PastListTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! PastParkingCell
